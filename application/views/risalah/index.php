                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php foreach ($data['bab_risalah'] as $item) {
                                ...
                                $lihatkomentar = '<li><a href="#" onclick="lihatkomentar(\''.$item->br_kode.'\')" data-toggle="modal"><i class="fa fa-comment"></i> Komentar</a></li>';
                                if (label_skin(['type'=>'warning','text'=>'revisi'])!=$data['stepStatusDesc'][$item->br_kode]){
                                    $lihatkomentar = '';
                                }
                            if ($data['stepStatus'][$item->br_kode]==3){
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#" onclick="showSubItem(\''.$item->br_kode.'\')"><i class="fa fa-edit"></i> Edit</a></li>'.$lihatkomentar.'
                                </ul>
                            </div>';
                            }else{
                                $btnpreview = '';
        ...
        <div class="col-md-8">
            <div class="box">
                ...
                <div class="box-footer">
                    <?= (empty($data['currentStep'])) ? '' : anchor('user/risalah/simpanbab'.$data['urllangkah'],'Simpan',array('class'=>'btn btn-primary'))  ?>
                </div>
            </div>
            <!-- /.box -->
        </div>
