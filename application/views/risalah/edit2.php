    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <?= form_open('admin/verifikasi/risalah/simpan/'.$param,array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body pad">
                    <textarea id="editor1" name="editor1" rows="30" cols="80"><?= @$data['val'] ?></textarea>
                </div>
                <div class="box-footer">
                    <div class="pull-right">
                        <?= anchor('admin/verifikasi/lihatrisalah/'.base64_encode($data['id_cip']),'Batal', array('class'=>'btn btn-default')) ?> &nbsp;
