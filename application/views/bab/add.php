        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Tambah Bab Risalah</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= form_open('admin/bab/simpan/',array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-sm-6 control-label">No <b style="color:red">*</b></label>
                            <div class="col-sm-6">
                                <input id="position" name="position" type="number" class="form-control" placeholder="Nomor Urut"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="nama" name="nama" type="text" class="form-control" placeholder="Nama BAB"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                echo form_dropdown('jenis_bab',$jenis,'',array('class'=>'form-control','required'=>'true')) ?>
                            </div>
                        </div>
                    </div>
                </div>
