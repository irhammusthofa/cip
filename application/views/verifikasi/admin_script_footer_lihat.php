...
function showTolak(id_bab,id_cip) {
    // param = decodeURIComponent(param);
    // param = JSON.parse(param);
    // var id_bab = param.id_bab;
    // var id_cip = param.id_cip;

    $('#frmTolak').attr('action', '/verifikasi/tolak/' + id_bab + '/' + id_cip);
    $('#modal-tolak-risalah').modal();
}
</script>