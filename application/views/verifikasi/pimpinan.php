        ...
        <div class="col-md-8">
            <div class="box">
                ...
                <div class="box-footer">
                    <?
                        if($data['currentStatus']==1 && $this->user->u_role=="pimpinan"){
                            echo anchor('pimpinan/risalah/simpanbab/'.base64_encode($data['id_cip']).'/'.$data['urllangkah'],'Simpan',array('class'=>'btn btn-primary'));
                        }
                    ?>
                </div>
            </div>
