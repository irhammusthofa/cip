...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url() ?>" class="logo">
      ...
      <span class="logo-mini"><b>C</b>Admin</span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left" hidden>
                  <?= anchor('user/profile','Profile',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
                <div class="pull-right">
                  <?= anchor('user/logout','Logout',array('class'=>'btn btn-default btn-flat')) ?>
                </div>
              </li>
            </ul>
          </li>
